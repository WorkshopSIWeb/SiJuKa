              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Tables <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables_admin.html">Table Admin</a></li>
                      <li><a href="tables_penjual.html">Table Penjual</a></li>
                      <li><a href="tables_pembeli.html">Table Pembeli</a></li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">Alex Rudi Herlambang
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="login.php"><i class="fa fa-sign-out pull-right"></i> Keluar</a></li>
                  </ul>
                </li>
            ...
            <div class="row top_tiles">
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <h3>Kelola Data Kebun</h3>
                  <p>Menu Untuk Memposting Data Kebun Yang Akan Dijual</p>
                </div>
              </div>
            </div>
          </div>
