...
<div id="frame">
            ...
            <?php
               ...
               while($d = mysqli_fetch_array($data)){
                       ?>
                          <tr>
                                <td>
                                       <img src="<?php echo "foto_profil/".$d['foto_profil']; ?>"width="30" height="30">
                                 </td>
                           </tr>
            <?php } ?>
						<div class="meta">
    ...
    <?php
    $query =mysqli_query($koneksi, "SELECT * FROM pesan WHERE id_pengirim = '$nik' and id_penerima = 12345123 OR id_pengirim = 12345123 and id_penerima = '$nik' ORDER BY tanggal asc");
