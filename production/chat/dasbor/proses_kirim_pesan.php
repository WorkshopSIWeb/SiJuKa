...
if(!(int)$penerima_kirim_pesan){
  ...
  $isi = mysqli_query($koneksi, "INSERT INTO pesan(id_pengirim, id_penerima, subyek_pesan, isi_pesan, sudah_dibaca) VALUES('$pengirim_kirim_pesan','$penerima_kirim_pesan','$subyek_kirim_pesan','$isi_kirim_pesan', 'belum')");
