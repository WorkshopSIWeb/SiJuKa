                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <td><?php
                          $kode = $row['kode_pelapor'];
                          $ky = mysqli_fetch_array(mysqli_query($koneksi, "SELECT nama_lengkap FROM tbl_user WHERE nik ='$kode'"));
                          echo $ky['nama_lengkap'];

                        ?></td>

                        <td><?php
                          $koded = $row['kode_dilapor'];
                          $ky = mysqli_fetch_array(mysqli_query($koneksi, "SELECT nama_lengkap FROM tbl_user WHERE nik ='$koded'"));
                          echo $ky['nama_lengkap'];
