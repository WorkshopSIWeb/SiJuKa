              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <tbody>
                  <?php
                  $query_daftar_pesan = mysqli_query($koneksi, "SELECT DISTINCT P.*, M.* FROM tbl_pesan P, tbl_user M WHERE P.id_penerima=M.nik AND P.id_pengirim='$id_member' AND subyek_pesan = 'BOOKING KAYU' AND P.status != 'belum' ORDER BY P.kode_pesan DESC");
