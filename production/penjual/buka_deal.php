                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          ...
                          <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Tindakan</a>
                          </li>
                        </ul>
                        <div id="myTabContent" class="tab-content">
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                            <h4>Bagaimana Keputusan anda ?</h4>
                            <br>
                            <br>
                            <form method="post" action="../php/deal.php" >
                              <?php
                              $al = mysqli_query($koneksi, "SELECT nik FROM tbl_user WHERE username='$orang'");
                              while ($row = $al->fetch_assoc()) {
                              $penjual = $row['nik'];
                            }
                             $beli = $_GET['id_pembeli']
                            ?>
                              <input type="hidden" value="<?php echo $beli;?>" name="pembeli">
                              <input type="hidden" value="<?php echo $penjual;?>" name="penjual">
