          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel Kebun <small>Penjual</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Berikut Tabel Daftar Kebun yang Tersedia
                    </p>
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th width="45px">No</th>
                          <th width="200px">Nama Penjual</th>
                          <th width="200px">Nama Pembeli</th>
                          <th width="200">Kayu</th>
                          <th>Waktu</th>
                          <th>Detail</th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        // $pemilik = $row['nik'];}
                        //
                        $sql ="SELECT * FROM tbl_deal ORDER BY tanggal_deal DESC";
                        $no=1;
                        ...
                        <td>
                          <?php
                          $penjual = $row['nikjual'];
                          $penj=mysqli_fetch_array(mysqli_query($koneksi, "SELECT nama_lengkap FROM tbl_user WHERE nik = '$penjual'"));
                          echo $penj['nama_lengkap'];
                          ?>
                        </td>
                        <td>
                          <?php
                            $pembeli = $row['nikbeli'];
                            $pemb=mysqli_fetch_array(mysqli_query($koneksi, "SELECT nama_lengkap FROM tbl_user WHERE nik = '$pembeli'"));
                            echo $pemb['nama_lengkap'];
                          ?>
                      </td>
                        <td>
                          <?php
                        ...
                        <td><?php echo $row['tanggal_deal'];?></td>
                        <td>
                          <a href="php/detail_deal.php?id=<?php echo $row['kode_deal']; ?>&jual=<?php echo $penjual; ?>&beli=<?php echo $pembeli?>&kayu=<?php echo $kode ?>" method="post" class="btn btn-danger"><li class="fa fa-mail"></li>Lihat detail</a>
                        </td>
                      </tr>
                      <?php
                        $no++;
